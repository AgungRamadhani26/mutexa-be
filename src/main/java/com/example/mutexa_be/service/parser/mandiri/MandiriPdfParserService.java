...
public class MandiriPdfParserService implements PdfParserService {
    ...
    private List<BankTransaction> extractLinesAndBuildTransactions(MutationDocument document, String entireText) {
        ...
        for (int i = 0; i < txLineIndices.size(); i++) {
            ...
            if (matcher.find()) {
                ...
                String finalRawDesc = rawDesc.toString().trim();
    ...
    private boolean isHeaderOrFooter(String line) {
        ...
        return ln.startsWith("e-Statement") ||
               ...
               ln.startsWith("ini adalah batas akhir") ||
               ln.startsWith("1. e-Statement") ||
               ln.startsWith("2. Segala bentuk") ||
               ln.startsWith("3. Nasabah dapat") ||
               ln.startsWith("4. Nasabah tunduk") ||
               ln.startsWith("Mandiri (Persero)") ||
               ln.startsWith("berizin dan diawasi") ||
               ln.contains("Electronic document generated by") ||
